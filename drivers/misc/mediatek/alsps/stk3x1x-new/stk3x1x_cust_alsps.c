...
//#endif	
    ...
    .i2c_addr   = {0x48, 0x00, 0x00, 0x00},	/*STK3x1x*/
        .als_level  = {5, 10, 15, 120, 480, 1000, 2000, 3500, 4000, 4600, 4600, 4600, 4600, 4600, 4600},	/* als_code */
        .als_value  = {10, 150, 500, 600, 1000, 4000, 6500, 8000, 9000, 10000, 10000, 10000, 10000, 10000, 10000, 10000 },    /* lux */
	.state_val = 0x0,		/* disable all */
	.psctrl_val = 0x71,		/* ps_persistance=4, ps_gain=64X, PS_IT=0.37ms */
