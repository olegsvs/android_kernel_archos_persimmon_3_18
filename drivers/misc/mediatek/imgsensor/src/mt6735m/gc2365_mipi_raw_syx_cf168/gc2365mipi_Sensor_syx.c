...
#include "gc2365mipi_Sensor_syx.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "GC2365_camera_sensor"
#define LOG_1 printk("GC2365,MIPI 2LANE\n")
/****************************   Modify end    *******************************************/
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC2365_SYX_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	printk("wilson gc2365 syx get_imgsensor_id start\n");
	gpio8_value = gpio_get_value(8);
	printk("wilson+++++gc2365 syx gpio8_value:%d, line:%d\n", gpio8_value, __LINE__);
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            if ((*sensor_id == imgsensor_info.sensor_id) &&(gpio8_value == 1)){
				printk("wilson gc2365 syx i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
                printk("i2c write id: 0x%x, sensor id: 0x%x, module is sanyingxin module\n", imgsensor.i2c_write_id,*sensor_id);
                return ERROR_NONE;
            }
            printk("Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
			printk("wilson gc2365 syx Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        retry = 2;
...
static kal_uint32 open(void)
{
	...
	int gpio8_value;
    LOG_1;
	printk("wilson+++++gc2365 syx open start\n");
	gpio8_value = gpio_get_value(8);
	printk("wilson++++++++++++ gc2365 syx gpio8_value:%d, line:%d\n", gpio8_value,__LINE__);
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            ...
            if ((sensor_id == imgsensor_info.sensor_id) &&(gpio8_value == 1)){
                ...
                printk("wilson gc2365 syx i2c write id: 0x%x, sensor id: 0x%x, module is sanyingxin module\n", imgsensor.i2c_write_id,sensor_id);
                break;
            }
            printk("wilson gc2365 syx Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,sensor_id);
            retry--;
    ...
    if ((imgsensor_info.sensor_id != sensor_id) || (gpio8_value != 1))
        return ERROR_SENSOR_CONNECT_FAIL;
	...
	printk("wilson+++++gc2365 syx open end\n");
...
UINT32 GC2365MIPI_SYX_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
