...
UINT32 OV5670_WE161_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//add by major for we161 ov5670
...
#endif
#if defined(OV5670_MIPI_RAW) || defined(SP5507_MIPI_RAW)
    {OV5670MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5670_MIPI_RAW, OV5670_MIPI_RAW_SensorInit},
#endif
#if defined(OV5670_MIPI_RAW_SYX)
    {OV5670MIPI_SYX_SENSOR_ID, SENSOR_DRVNAME_OV5670_SYX_MIPI_RAW, OV5670_SYX_MIPI_RAW_SensorInit},
#endif
//add by major for we161 ov5670
#if defined(OV5670_MIPI_RAW_WE161)
    {OV5670MIPI_WE161_SENSOR_ID, SENSOR_DRVNAME_OV5670_WE161_MIPI_RAW, OV5670_WE161_MIPI_RAW_SensorInit},
#endif
// add end 
#if defined(GC5005_MIPI_RAW_CF168)
...
#endif
#if defined(S5K4H8_MIPI_RAW_CF168)
...
#endif
#if defined(GC2365_MIPI_RAW_CF168)
    {GC2365_SENSOR_ID, SENSOR_DRVNAME_GC2365_MIPI_RAW, GC2365MIPI_RAW_SensorInit},
#endif
#if defined(GC2365_MIPI_RAW_SYX_CF168)
    {GC2365_SYX_SENSOR_ID, SENSOR_DRVNAME_GC2365_SYX_MIPI_RAW, GC2365MIPI_SYX_RAW_SensorInit},
#endif
