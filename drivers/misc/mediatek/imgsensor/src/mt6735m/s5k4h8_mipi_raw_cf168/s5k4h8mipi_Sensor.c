...
extern bool S5K4H8YX13_get_otp_date(BYTE Page);

static DEFINE_SPINLOCK(imgsensor_drv_lock);
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = S5K4H8_SENSOR_ID,
	.checksum_value = 0x4d4c670f,
	.pre = {
...
/////////////////////////////////////////////////////////////////////////
////////// OTP S5K4H8YX13 Start --------------------------------------------
/////////////////////////////////////////////////////////////////////////
//#define tRG_Ratio_typical    593   //0X2F0
//#define tBG_Ratio_typical   630   //0X259
#define tRG_Ratio_typical    593   //0X2F0
#define tBG_Ratio_typical   630   //0X259
#define tGbGr_Ratio_typical    1030   //0X259

struct S5K4H8YX13_MIPI_otp_struct
{
	BYTE AWB_Flag;
	BYTE AWB_Group;
	BYTE LSC_Flag;
...
struct S5K4H8YX13_MIPI_otp_struct S5K4H8YX13_OTP_Infor;
...
bool start_read_otp(BYTE Page)
{
    ...
    write_cmos_sensor_8(0x6F12, 0x01); //stream on ,20151224
    
  //write_cmos_sensor_8(0x0A00, 0x04);   //make initial state
  for(i=0 ; i<64 ; i++)
  {
  	write_cmos_sensor_8(0x0A04+i, 0x00);//Disable NVM controller
  }
...
**************************************************************************************************/
BYTE S5K4H8YX13_Get_OTP_Info(BYTE Page)
{
    BYTE Flag_AWB_Group1 = 0x00, Flag_AWB_Group2 = 0x00, Flag_AWB= 0x00 ,AWB_Gloup=0;
    BYTE Flag_LSC_Group1 = 0x00, Flag_LSC_Group2 = 0x00, Flag_LSC= 0x00 ,LSC_Gloup=0;
    
    printk("S5K4H8YX13_Get_OTP_Info \n");
    printk("S5K4H8YX13_Get_OTP_Info page=%d\n",Page);
    if(Page>15||Page<15)
    {
    	return Flag_AWB;
    }
    ...
    Flag_AWB_Group1= read_cmos_sensor_8(0x0A04)&0xff;
    Flag_AWB_Group2= read_cmos_sensor_8(0x0A24)&0xff;
    Flag_LSC_Group1= read_cmos_sensor_8(0x0A13)&0xff;
    Flag_LSC_Group2= read_cmos_sensor_8(0x0A33)&0xff;
    
    printk("S5K4H8YX13 Flag_AWB_Group1=%d ,Flag_AWB_Group2=%d ,\n",Flag_AWB_Group1,Flag_AWB_Group2);
    printk("S5K4H8YX13 Flag_LSC_Group1=%d ,Flag_LSC_Group2=%d ,\n",Flag_LSC_Group1,Flag_LSC_Group2);
    if(Flag_AWB_Group2==0x40)
    	{
    		AWB_Gloup=2;
    		Flag_AWB=1;
    	}
    ...
    S5K4H8YX13_OTP_Infor.AWB_Flag= Flag_AWB;
		S5K4H8YX13_OTP_Infor.AWB_Group= AWB_Gloup;
		S5K4H8YX13_OTP_Infor.LSC_Flag= Flag_LSC;
		S5K4H8YX13_OTP_Infor.LSC_Group= LSC_Gloup;
		printk("S5K4H8YX13 Flag_AWB=%d ,AWB_Gloup=%d ,\n",Flag_AWB,AWB_Gloup);
		printk("S5K4H8YX13 Flag_LSC=%d ,LSC_Gloup=%d ,\n",Flag_AWB,AWB_Gloup);
		
    stop_read_otp();
		
		if(Flag_AWB==1)
		{
			S5K4H8YX13_get_otp_date(Page);
		}
		else
			{
				S5K4H8YX13_OTP_Infor.MID=0x45;
				S5K4H8YX13_OTP_Infor.Year=15;
				S5K4H8YX13_OTP_Infor.Month=11;
				S5K4H8YX13_OTP_Infor.Day=25;
				S5K4H8YX13_OTP_Infor.Lens_id=0x00;
				S5K4H8YX13_OTP_Infor.VCM_id=0x00;
				S5K4H8YX13_OTP_Infor.DriverIC_id=0x00;
				S5K4H8YX13_OTP_Infor.AWB_Checksum =0;
				S5K4H8YX13_OTP_Infor.LSC_Checksum =0;
				
				S5K4H8YX13_OTP_Infor.AWB_RG=tRG_Ratio_typical;
				S5K4H8YX13_OTP_Infor.AWB_BG=tBG_Ratio_typical;
				S5K4H8YX13_OTP_Infor.AWB_GbGr=tGbGr_Ratio_typical;
				
			}
		
    printk("S5K4H8YX13 : Flag_AWB=0x%02x,Flag_LSC=0x%02x \n", Flag_AWB, Flag_LSC );
	printk("wilson AWB_RG=%d, AWB_BG=%d, AWB_GbGr=%d\n", S5K4H8YX13_OTP_Infor.AWB_RG, S5K4H8YX13_OTP_Infor.AWB_BG, S5K4H8YX13_OTP_Infor.AWB_GbGr);
	  return Flag_AWB;
}
...
* Parameters  :  [BYTE] zone : OTP PAGE index , 0x00~0x0f    
**************************************************************************************************/
bool S5K4H8YX13_get_otp_date(BYTE Page) 
{
	BYTE MID  = 0, Lens_id = 0, VCM_id   = 0, DriverIC_id=0;
	BYTE Year  = 0, Month = 0, Day   = 0;
	BYTE awb_rg_msb  = 0, awb_rg_lsb = 0, awb_bg_msb   = 0, awb_bg_lsb = 0;
	BYTE awb_GbGr_msb  = 0, awb_GbGr_lsb = 0;

	BYTE AWB_Checksum=0,LSC_Checksum=0,Temp_Checksum=0;
	int Start_Address =0;
	printk("S5K4H8YX13_get_otp_date \n");
	printk("S5K4H8YX13_get_otp_date page =%d \n", Page);
	start_read_otp(Page);
	if(S5K4H8YX13_OTP_Infor.AWB_Group==1)
		{
			Start_Address= 0x0a06;
		}
		else
		{
				if(S5K4H8YX13_OTP_Infor.AWB_Group==2)
					{
				    Start_Address= 0x0a26;
					}
					else
						{
							S5K4H8YX13_OTP_Infor.MID=0x45;
	...
	MID  = read_cmos_sensor_8(Start_Address)&0xff;
	Year = read_cmos_sensor_8(Start_Address+1)&0xff;
	Month  = read_cmos_sensor_8(Start_Address+2)&0xff;
	Day  = read_cmos_sensor_8(Start_Address+3)&0xff;
	Lens_id = read_cmos_sensor_8(Start_Address+4)&0xff;
	VCM_id  = read_cmos_sensor_8(Start_Address+5)&0xff;
	DriverIC_id  = read_cmos_sensor_8(Start_Address+6)&0xff;
	
	awb_rg_msb   = read_cmos_sensor_8(Start_Address+7)&0xff;
	awb_rg_lsb   = read_cmos_sensor_8(Start_Address+8)&0xff;
	awb_bg_msb   = read_cmos_sensor_8(Start_Address+9)&0xff;
	awb_bg_lsb   = read_cmos_sensor_8(Start_Address+10)&0xff;
	awb_GbGr_msb = read_cmos_sensor_8(Start_Address+11)&0xff;
	awb_GbGr_lsb = read_cmos_sensor_8(Start_Address+12)&0xff;
	AWB_Checksum = read_cmos_sensor_8(Start_Address-1)&0xff;
	LSC_Checksum = read_cmos_sensor_8(Start_Address+14)&0xff;
		
	S5K4H8YX13_OTP_Infor.MID=MID;
	S5K4H8YX13_OTP_Infor.Year=Year;
	S5K4H8YX13_OTP_Infor.Month=Month;
	S5K4H8YX13_OTP_Infor.Day=Day;
	S5K4H8YX13_OTP_Infor.Lens_id=Lens_id;
	S5K4H8YX13_OTP_Infor.VCM_id=VCM_id;
	S5K4H8YX13_OTP_Infor.DriverIC_id=DriverIC_id;
	S5K4H8YX13_OTP_Infor.AWB_Checksum =AWB_Checksum;
	S5K4H8YX13_OTP_Infor.LSC_Checksum =LSC_Checksum;
	 
	Temp_Checksum=(MID+Year+Month+Day+Lens_id+VCM_id+DriverIC_id+ awb_rg_msb+awb_rg_lsb+awb_bg_msb+awb_bg_lsb+awb_GbGr_msb+awb_GbGr_lsb)%255 +1;
	if(Temp_Checksum==AWB_Checksum)
	{		
		S5K4H8YX13_OTP_Infor.AWB_RG=((awb_rg_msb<<8)&0x0f00)|(awb_rg_lsb&0XFF);
		S5K4H8YX13_OTP_Infor.AWB_BG=((awb_bg_msb<<8)&0x0f00)|(awb_bg_lsb&0XFF);
		S5K4H8YX13_OTP_Infor.AWB_GbGr=((awb_GbGr_msb<<8)&0x0f00)|(awb_GbGr_lsb&0XFF);
	}
	else
		{
			S5K4H8YX13_OTP_Infor.AWB_RG=tRG_Ratio_typical;
  ...
  printk("S5K4H8YX13 Module Information \n");
	printk("S5K4H8YX13 ModuleID=%02x \n", MID);
	printk("S5K4H8YX13 AWB_RG_MSB=%X ,AWB_RG_LSB=%X\n",awb_rg_msb,awb_rg_lsb);
	printk("S5K4H8YX13 AWB_BG_MSB=%X ,AWB_BG_LSB=%X\n",awb_bg_msb,awb_bg_lsb);
	printk("S5K4H8YX13 AWB_GbGr_MSB=%X ,AWB_GbGr_LSB=%X\n",awb_GbGr_msb,awb_GbGr_lsb);
	
	printk("S5K4H8YX13 AWB_RG=%X \n",S5K4H8YX13_OTP_Infor.AWB_RG);
	printk("S5K4H8YX13 AWB_BG=%X \n",S5K4H8YX13_OTP_Infor.AWB_BG);
	printk("S5K4H8YX13 AWB_G=%X \n",S5K4H8YX13_OTP_Infor.AWB_GbGr);
...
**************************************************************************************************/
#if 0
bool S5K4H8YX13_OTP_LSC_update(struct S5K4H8YX13_MIPI_otp_struct *otp)
{
    BYTE  flag_LSC = 0;
//    int  Value =0;
    printk("S5K4H8YX13_OTP_LSC_update\n");
    ...
    {
  				//LSC correct
	        printk("S5K4H8YX13: LSC Auto Correct OK! \n");
	        //Value = read_cmos_sensor_8(0x0B00);
	        //Value = Value | 0x01;
    ...
    {
    	printk("S5K4H8YX13 : OTP LSC EEROR! \n");
    	return 0;
    	}
    printk("S5K4H8YX13 : OTP LSC Update Finished! \n");
    return 1;
}
#endif

void S5K4H8YX13_MIPI_Algorithm_OTP_AWB(struct S5K4H8YX13_MIPI_otp_struct *otp)
{
	kal_uint32 R_to_G=0, B_to_G=0 , Gb_to_Gr=0;
	kal_uint32 R_Gain=0, B_Gain=0, G_Gain=0;
	kal_uint32 Gr_Gain=0,Gb_Gain=0;
	kal_uint32 G_gain_R=0, G_gain_B=0;
	
	R_to_G = otp->AWB_RG;
	B_to_G = otp->AWB_BG;
	Gb_to_Gr= otp->AWB_GbGr;//tGbGr_Ratio_typical

	printk("S5K4H8YX13_MIPI_Algorithm_OTP_AWB \n");	
	printk("S5K4H8YX13_MIPI_Algorithm_OTP_AWB: R_to_G=%d\n", R_to_G);	
	printk("S5K4H8YX13_MIPI_Algorithm_OTP_AWB: B_to_G=%d\n", B_to_G);	
	printk("S5K4H8YX13_MIPI_Algorithm_OTP_AWB: Gb_to_Gr=%d\n", Gb_to_Gr);	
...
if(R_to_G < tRG_Ratio_typical )
   ...
   //Gr_Gain=(2*G_Gain)/((tGbGr_Ratio_typical/Gb_to_Gr)+1);
   //Gb_Gain=(2*G_Gain)-Gr_Gain; 
  
	printk("S5K4H8YX13_MIPI_Algorithm_OTP_AWB: R_gain=0x%x\n", R_Gain);	
	printk("S5K4H8YX13_MIPI_Algorithm_OTP_AWB: Gr_Gain=0x%x,Gb_Gain=0x%x\n",Gr_Gain, Gb_Gain);	
	printk("S5K4H8YX13_MIPI_Algorithm_OTP_AWB: B_gain=0x%x\n", B_Gain);
...
void S5K4H8YX13_OTP_AWB_update(struct S5K4H8YX13_MIPI_otp_struct *otp)
{
	printk("S5K4H8YX13_OTP_AWB_update\n");
	//if(flag_AWB==1)
	
		S5K4H8YX13_MIPI_Algorithm_OTP_AWB(otp);
}
////////// OTP S5K4H8 End --------------------------------------------
/////////////////////////////////////////////////////////////////////////
...
static void sensor_init(void)
{
 ...
 write_cmos_sensor(0x6028, 0x4000);
	...
	write_cmos_sensor_8(0x6F12, 0x00);  //LSC off
#endif
...
write_cmos_sensor(0x0340, 0x09C2); //2498
...
#if 0 //otp
S5K4H8YX13_OTP_AWB_update(&S5K4H8YX13_OTP_Infor);
S5K4H8YX13_OTP_LSC_update(&S5K4H8YX13_OTP_Infor);
#endif
write_cmos_sensor(0x6028, 0x4000);
...
write_cmos_sensor(0x034E, 0x0990);
write_cmos_sensor(0x0342, 0x0EA0);
write_cmos_sensor(0x0340, 0x09BC); //2492
write_cmos_sensor(0x0900, 0x0111);
write_cmos_sensor(0x0380, 0x0001);
write_cmos_sensor(0x0382, 0x0001);
write_cmos_sensor(0x0384, 0x0001);
...
write_cmos_sensor(0xF45C, 0x0004);
write_cmos_sensor(0x0B04, 0x0101);
//write_cmos_sensor(0x0B00, 0x0080); //LSC hs_video_setting
write_cmos_sensor(0x6028, 0x2000);
write_cmos_sensor(0x602A, 0x0C40);
write_cmos_sensor(0x6F12, 0x0140);
write_cmos_sensor(0x6028, 0x4000);
...
write_cmos_sensor(0x0342, 0x0EA0);
write_cmos_sensor(0x0340, 0x0280); //640
...
write_cmos_sensor(0xF45C, 0x0004);
write_cmos_sensor(0x0B04, 0x0101);
//write_cmos_sensor(0x0B00, 0x0080); //LSC slim_video_setting
write_cmos_sensor(0x6028, 0x2000);
write_cmos_sensor(0x602A, 0x0C40);
write_cmos_sensor(0x6F12, 0x0140);
write_cmos_sensor(0xFCFC, 0x4000);
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
			...
			*sensor_id = read_cmos_sensor(0x6F12);
			...
			printk("---wuzz---s5k4h8 read sensor id: 0x%x\n",*sensor_id);
            if (*sensor_id == imgsensor_info.sensor_id) {               
                printk("---wuzz---s5k4h8 ok i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);      
                return ERROR_NONE;
            }   
            printk("---wuzz---s5k4h8 Read sensor id fail, write id: 0x%x, sensor id = 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        retry = 1;
...
static kal_uint32 open(void)
{
	...
	//sensor have two i2c address 0x5a 0x5b & 0x21 0x20, we should detect the module used i2c address
        ...
        do {
            ...
            LOG_INF("Read sensor id fail:%x, id: 0x%x\n", imgsensor.i2c_write_id,sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        if (sensor_id == imgsensor_info.sensor_id)
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	preview_setting();
		...
		#if 1
    	 LOG_INF("update otp begin\n");
       if(S5K4H8YX13_Get_OTP_Info(15))
       {
       	    LOG_INF("otp data exist\n");
            S5K4H8YX13_OTP_AWB_update(&S5K4H8YX13_OTP_Infor);                             
       }
       else
        {
          //LSC OFF
          LOG_INF("otp data LSC wrong\n");
        	write_cmos_sensor(0x6028, 0x4000);
        	write_cmos_sensor(0x602A, 0x0B00);
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if (enable) {
     ...
     write_cmos_sensor(0x0200, 0x0002);
      ...
      write_cmos_sensor(0x0600, 0x0304);//0x0002
	} else {
		// 0x5E00[8]: 1 enable,  0 disable
		// 0x5E00[1:0]; 00 Color bar, 01 Random Data, 10 Square, 11 BLACK
