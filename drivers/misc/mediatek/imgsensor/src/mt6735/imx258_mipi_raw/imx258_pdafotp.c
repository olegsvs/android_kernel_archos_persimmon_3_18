...
bool read_imx258_eeprom_pdaf( kal_uint16 addr, BYTE* data, kal_uint32 size){
	addr = 0x076C; //ofilm beg at 0x76C
	size = 1356;
	
	LOG_INF("read imx258 eeprom pdaf, size = %d\n", size);
...
//	int i;
	addr = 0x0CB9 ;//F73;//0x0F73;
	size = 126;
	
	LOG_INF("read imx258 eeprom spc, size = %d\n", size);
