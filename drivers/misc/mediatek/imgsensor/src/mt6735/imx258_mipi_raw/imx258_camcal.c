...
*
********************************************************************************/
#define CAM_CAL_DRVNAME "IMX258_CAM_CAL_DRV"
#define CAM_CAL_CLASS_NAME "IMX258_CAM_CALdrv"
...
#define IMX258_OTP_AWB_CALIBRATION
...
static OTP_DATA darren_imx258_eeprom_data = {{0}};
...
int read_imx258_ofg_eeprom_mtk_fmt(void)
{
	int i = 0;
...
//	spin_unlock(&g_CAM_CALLock);
	...
	// for ofg
	//read flag
	read_imx258_eeprom(0x0000, &darren_imx258_eeprom_data.data[0x00], 31);
	//read module info
//	read_imx258_eeprom(0x0001, &darren_imx258_eeprom_data.data[0x01], 16);
//	
//	//read awb/af flag
//	read_imx258_eeprom(0x0010, &darren_imx258_eeprom_data.data[0x10], 2);
//	
//	//read awb
//	read_imx258_eeprom(0x0012, &darren_imx258_eeprom_data.data[0x12], 8);
//		
//	//reaf afinf
//	read_imx258_eeprom(0x001A, &darren_imx258_eeprom_data.data[0x1A], 2);
//	//read afmarco
//	read_imx258_eeprom(0x001C, &darren_imx258_eeprom_data.data[0x1C], 2);
	
	//read lsc table
	read_imx258_eeprom(0x001F, &darren_imx258_eeprom_data.data[0x1F], 1868);
	
	for (i = 0; i < 0x1F; i++)
	{
		CAM_CALDB("darren eeprom_Data[%02x] = %02x\n", i, darren_imx258_eeprom_data.data[i]);
	}
	return 1;
}
...
{
	memcpy((void*)data,(void*)&darren_imx258_eeprom_data.data[offset],size);
	CAM_CALDB("selective_ofg_read_region offset = %x, size:%d \n",offset,size);
	return size;
}
#endif
            ...
            stCAM_CAL_INFO_STRUCT __user *data)
{
    ...
    err |= put_user(p, (compat_uptr_t *)&data32->pu1Params);
#endif
    return err;
}
