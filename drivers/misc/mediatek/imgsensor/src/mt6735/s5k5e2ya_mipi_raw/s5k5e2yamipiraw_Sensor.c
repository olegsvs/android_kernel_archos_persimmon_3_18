...
////////// OTP S5K5E2YA Start --------------------------------------------
/////////////////////////////////////////////////////////////////////////
#define tRG_Ratio_typical    752   //0X2F0
#define tBG_Ratio_typical    601   //0X259
...
struct S5K5E2YA_MIPI_otp_struct * S5K5E2YA_OTP_Infor_Ptr = &S5K5E2YA_OTP_Infor;
...
bool S5K5E2YA_get_otp_date(BYTE Page) 
{
	...
	MID  = read_cmos_sensor(0x0A05);
	Year = read_cmos_sensor(0x0A06);
	Month  = read_cmos_sensor(0x0A07);
	Day  = read_cmos_sensor(0x0A08);
	Lens_id = read_cmos_sensor(0x0A09);
	VCM_id  = read_cmos_sensor(0x0A0A);
	DriverIC_id  = read_cmos_sensor(0x0A0B);
	
	awb_rg_msb   = read_cmos_sensor(0x0A0C);
	awb_rg_lsb   = read_cmos_sensor(0x0A0D);
	awb_bg_msb   = read_cmos_sensor(0x0A0E);
	awb_bg_lsb   = read_cmos_sensor(0x0A0F);
	awb_GbGr_msb = read_cmos_sensor(0x0A10);
	awb_GbGr_lsb = read_cmos_sensor(0x0A11);
...
**************************************************************************************************/
BYTE S5K5E2YA_Get_OTP_Info(BYTE Page)
{
    BYTE Flag_AWB = 0x00;
    BYTE Flag_LSC = 0x00;
    
    printk("S5K5E2YA Page N0 2: page error \n");
    if(Page>3||Page<2)
    {
    ...
    Flag_AWB=read_cmos_sensor(0x0A04);
    Flag_LSC=read_cmos_sensor(0x0A13);
    
    stop_read_otp();

		S5K5E2YA_OTP_Infor.AWB_Flag=Flag_AWB;
		S5K5E2YA_OTP_Infor.LSC_Flag=Flag_LSC;
		
		if(Flag_AWB==1)
		{
			S5K5E2YA_get_otp_date(Page);
		}
		else
			{
				S5K5E2YA_OTP_Infor.MID=0x00;
				S5K5E2YA_OTP_Infor.Year=15;
				S5K5E2YA_OTP_Infor.Month=11;
				S5K5E2YA_OTP_Infor.Day=25;
				S5K5E2YA_OTP_Infor.Lens_id=0x00;
				S5K5E2YA_OTP_Infor.VCM_id=0x00;
				S5K5E2YA_OTP_Infor.DriverIC_id=0x00;
    ...
    printk("S5K5E2YA : Flag_AWB=0x%02x,Flag_LSC=0x%02x \n", Flag_AWB, Flag_LSC );
	  return Flag_AWB;
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	LOG_INF("s5k5e2 get_imgsensor_id");
...
//			LOG_INF("Read sensor id fail, id: 0x%x\n", imgsensor.i2c_write_id,sensor_id);
	...
	sensor_init();
	S5K5E2YA_Get_OTP_Info(2);
	
	#if 1
  #if 1 //Lens shading 
  S5K5E2YA_OTP_LSC_update(S5K5E2YA_OTP_Infor_Ptr);
  #endif 
	    
  #if 1 //awb using
  S5K5E2YA_OTP_AWB_update(S5K5E2YA_OTP_Infor_Ptr);
  #endif
