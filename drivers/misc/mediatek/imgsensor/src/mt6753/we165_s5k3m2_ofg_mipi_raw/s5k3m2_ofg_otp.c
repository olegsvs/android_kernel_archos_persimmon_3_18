...
bool read_3m2_ofg_eeprom( kal_uint16 addr, BYTE* data, kal_uint32 size){
//	int i;
//	addr = 0x0000;
//	size = 20;
//	
...
bool read_3m2_ofg_pdaf( kal_uint16 addr, BYTE* data, kal_uint32 size){
	addr = 0x0763;
	size = 1404;
//	
	LOG_INF("read 3m2 eeprom, size = %d\n", size);
