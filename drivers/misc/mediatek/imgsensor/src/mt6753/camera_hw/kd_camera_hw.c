...
#define VOL_1000 1000000
	...
	if (On) {
		...
		if ((currSensorName && (0 == strcmp(currSensorName, "imx135mipiraw"))) ||
			...
			((0 == strcmp(SENSOR_DRVNAME_OV5648_MIPI_RAW_OFG, currSensorName)) || (0 == strcmp(SENSOR_DRVNAME_OV5648_MIPI_RAW_QT, currSensorName)) || (0 == strcmp(SENSOR_DRVNAME_OV5648_MIPI_RAW, currSensorName)))) {
			printk("ov5648 power up\n");
		...
		else if (currSensorName &&((0 == strcmp(BF168_SENSOR_DRVNAME_OV5670_MIPI_RAW, currSensorName))||
						(0 == strcmp(WE165_SENSOR_DRVNAME_OV5670_MIPI_RAW, currSensorName))))
		{
//First Power Pin low and Reset Pin Low
...
#define IDX_PS_OFF  3
	...
	if (On) {
						...
						(0 == strcmp(WE165_SENSOR_DRVNAME_OV5670_MIPI_RAW, currSensorName))))
		{
            ...
            if(TRUE != _hwPowerDown(VCAMD,mode_name))
            {
                 PK_DBG("[CAMERA SENSOR] Fail to OFF core power (VCAM_D), power id = %d \n",VCAMD);
                 goto _kdCISModulePowerOn_exit_;
            }
            ...
            //VCAM_A
            if(TRUE != _hwPowerDown(VCAMA,mode_name)) {
                PK_DBG("[CAMERA SENSOR] Fail to OFF analog power (VCAM_A), power id= (%d) \n", VCAMA);
                //return -EIO;
                goto _kdCISModulePowerOn_exit_;
            }
            ...
            //VCAM_IO
            if(TRUE != _hwPowerDown(VCAMIO, mode_name)) {
                PK_DBG("[CAMERA SENSOR] Fail to OFF digital power (VCAM_IO), power id = %d \n", VCAMIO);
                //return -EIO;
                goto _kdCISModulePowerOn_exit_;
            }
