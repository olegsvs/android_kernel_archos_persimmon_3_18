 ...
 *
 ****************************************************************************/
#ifndef _S5K3M2MIPI_OFG_SENSOR_H
#define _S5K3M2MIPI_OFG_SENSOR_H
...
extern bool read_3m2_ofg_pdaf( kal_uint16 addr, BYTE* data, kal_uint32 size);
extern int selective_ofg_read_region(u32 offset, u32 size, BYTE* data);
#endif 
