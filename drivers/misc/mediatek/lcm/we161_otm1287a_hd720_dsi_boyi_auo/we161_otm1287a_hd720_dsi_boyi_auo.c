...
static int OTP_FLAG = 0; //add by darren
...
LCM_DRIVER we161_otm1287a_hd720_dsi_boyi_auo_lcm_drv=
{
    .name           	= "we162_otm1287a_hd720_dsi_boyi_auo",
