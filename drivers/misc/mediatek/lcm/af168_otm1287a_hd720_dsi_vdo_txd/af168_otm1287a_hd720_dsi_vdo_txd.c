...
//	{0xD9,1,{0x3e}},   //does not config reg 0xD9
...
static unsigned int lcm_compare_id(void)
{
	...
	if (channel_data < 100 )   
	{
	    module_id = OTM1287A_MODULE_TXD; //TXD modules
	} 
   
	if (((id2<<8 | id3) == OTM1287A_HD720_ID) && (module_id == OTM1287A_MODULE_TXD))
    {
    #ifdef BUILD_LK
...
LCM_DRIVER af168_otm1287a_hd720_dsi_vdo_txd_lcm_drv = {
	.name           = "af168_otm1287a_hd720_dsi_vdo_txd",
