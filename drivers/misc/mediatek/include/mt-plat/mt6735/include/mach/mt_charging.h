...
#elif defined (CONFIG_DW_PROJECT_WE162)
...
#define V_CC2TOPOFF_THRES		4220//4050
#define RECHARGING_VOLTAGE      4181// for HIGH_BATTERY_VOLTAGE_SUPPORT
#define CHARGING_FULL_CURRENT    100
#elif defined(CONFIG_DW_PROJECT_WE161) || defined (CONFIG_DW_PROJECT_WE162)//add by major for we61
#define V_PRE2CC_THRES          3400
#define V_CC2TOPOFF_THRES		4220
#define RECHARGING_VOLTAGE      4200
#define CHARGING_FULL_CURRENT    140
...
#elif defined(CONFIG_DW_PROJECT_WE161)
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_2000_00_MA
#elif defined(CONFIG_DW_PROJECT_WE162)    //add by major for we162
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_1300_00_MA
#elif defined(CONFIG_DW_PROJECT_BF168) //add by major for bf168
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_2000_00_MA
#elif defined(CONFIG_DW_PROJECT_WE165) //add by major for bf168
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_2000_00_MA
#else
...
#define V_CHARGER_MIN 3000				/* 4.4 V	*/
...
#if defined(CONFIG_DW_PROJECT_AF168) || defined(CONFIG_DW_PROJECT_AF178)|| defined(CONFIG_DW_PROJECT_CF168) || defined(CONFIG_DW_PROJECT_ZE168) || defined(CONFIG_DW_PROJECT_WE161) || defined(CONFIG_DW_PROJECT_WE165) || defined(CONFIG_DW_PROJECT_WE162)
