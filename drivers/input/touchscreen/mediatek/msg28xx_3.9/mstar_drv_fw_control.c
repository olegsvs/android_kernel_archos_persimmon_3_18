        ...
        if (bIsCorrectFormat) 
        {
            ...
            switch (nWakeupMode)
            {
                case 0x58:
                    ...
                    input_report_key(g_InputDevice, KEY_SDE_ENTER, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEY_SDE_ENTER, 0);
                    input_sync(g_InputDevice);
                    break;		
                case 0x60:
...
//                    input_report_key(g_InputDevice, KEY_UP, 1);
                    input_report_key(g_InputDevice, KEY_SDE_UP, 1);
                    input_sync(g_InputDevice);
//                    input_report_key(g_InputDevice, KEY_UP, 0);
                    input_report_key(g_InputDevice, KEY_SDE_UP, 0);
                    input_sync(g_InputDevice);
                    break;		
                case 0x61:
...
//                    input_report_key(g_InputDevice, KEY_DOWN, 1);
                    input_report_key(g_InputDevice, KEY_SDE_DOWN, 1);
                    input_sync(g_InputDevice);
//                    input_report_key(g_InputDevice, KEY_DOWN, 0);
                    input_report_key(g_InputDevice, KEY_SDE_DOWN, 0);
                    input_sync(g_InputDevice);
                    break;		
                case 0x62:
...
//                  input_report_key(g_InputDevice, KEY_LEFT, 1);
                    input_report_key(g_InputDevice, KEY_SDE_LEFT, 1);
                    input_sync(g_InputDevice);
//                    input_report_key(g_InputDevice, KEY_LEFT, 0);
                    input_report_key(g_InputDevice, KEY_SDE_LEFT, 0);
                    input_sync(g_InputDevice);
                    break;		
                case 0x63:
...
//                    input_report_key(g_InputDevice, KEY_RIGHT, 1);
                    input_report_key(g_InputDevice, KEY_SDE_RIGHT, 1);
                    input_sync(g_InputDevice);
//                    input_report_key(g_InputDevice, KEY_RIGHT, 0);
                    input_report_key(g_InputDevice, KEY_SDE_RIGHT, 0);
                    input_sync(g_InputDevice);
                    break;		
                case 0x64:
...
//                    input_report_key(g_InputDevice, KEY_M, 1);
                    input_report_key(g_InputDevice, KEY_SDE_M, 1);
                    input_sync(g_InputDevice);
//                    input_report_key(g_InputDevice, KEY_M, 0);
                    input_report_key(g_InputDevice, KEY_SDE_M, 0);
                    input_sync(g_InputDevice);
                    break;		
                case 0x65:
...
//                    input_report_key(g_InputDevice, KEY_W, 1);
                    input_report_key(g_InputDevice, KEY_SDE_W, 1);
                    input_sync(g_InputDevice);
//                    input_report_key(g_InputDevice, KEY_W, 0);
                    input_report_key(g_InputDevice, KEY_SDE_W, 0);
                    input_sync(g_InputDevice);
                    break;		
                case 0x66:
...
//                    input_report_key(g_InputDevice, KEY_C, 1);
                    input_report_key(g_InputDevice, KEY_SDE_C, 1);
                    input_sync(g_InputDevice);
//                    input_report_key(g_InputDevice, KEY_C, 0);
                    input_report_key(g_InputDevice, KEY_SDE_C, 0);
                    input_sync(g_InputDevice);
                    break;
                case 0x67:
...
//                    input_report_key(g_InputDevice, KEY_E, 1);
                    input_report_key(g_InputDevice, KEY_SDE_E, 1);
                    input_sync(g_InputDevice);
//                    input_report_key(g_InputDevice, KEY_E, 0);
                    input_report_key(g_InputDevice, KEY_SDE_E, 0);
                    input_sync(g_InputDevice);
                    break;
                case 0x68:
...
//                    input_report_key(g_InputDevice, KEY_V, 1);
                    input_report_key(g_InputDevice, KEY_SDE_V, 1);
                    input_sync(g_InputDevice);
//                    input_report_key(g_InputDevice, KEY_V, 0);
                    input_report_key(g_InputDevice, KEY_SDE_V, 0);
                    input_sync(g_InputDevice);
                    break;
                case 0x69:
...
//                    input_report_key(g_InputDevice, KEY_O, 1);
                    input_report_key(g_InputDevice, KEY_SDE_O, 1);
                    input_sync(g_InputDevice);
//                    input_report_key(g_InputDevice, KEY_O, 0);
                    input_report_key(g_InputDevice, KEY_SDE_O, 0);
                    input_sync(g_InputDevice);
                    break;
                case 0x6A:
...
//                    input_report_key(g_InputDevice, KEY_S, 1);
                    input_report_key(g_InputDevice, KEY_SDE_S, 1);
                    input_sync(g_InputDevice);
//                    input_report_key(g_InputDevice, KEY_S, 0);
                    input_report_key(g_InputDevice, KEY_SDE_S, 0);
                    input_sync(g_InputDevice);
                    break;
                case 0x6B:
...
//                    input_report_key(g_InputDevice, KEY_Z, 1);
                    input_report_key(g_InputDevice, KEY_SDE_Z, 1);
                    input_sync(g_InputDevice);
//                    input_report_key(g_InputDevice, KEY_Z, 0);
                    input_report_key(g_InputDevice, KEY_SDE_Z, 0);
                    input_sync(g_InputDevice);
                    break;
                case 0x6C:
