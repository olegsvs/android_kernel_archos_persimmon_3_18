...
int g_TpVirtualKey[] = {TOUCH_KEY_BACK, 102, TOUCH_KEY_MENU, TOUCH_KEY_SEARCH};
...
int g_TpVirtualKeyDimLocal_factory[MAX_KEY_NUM][4] = {{90, 900, 100, 40}, {230, 900, 100, 40}, {370, 900, 100, 40}, {0, 0, 0, 0}};
#endif 
...
*/
    ...
    input_set_capability(g_InputDevice, EV_KEY, KEY_GESTURE_U);
#endif //CONFIG_ENABLE_GESTURE_WAKEUP
