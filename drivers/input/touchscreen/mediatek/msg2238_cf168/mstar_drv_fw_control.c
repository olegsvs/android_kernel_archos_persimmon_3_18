...
#include "msg2xxx_hxd_cf168_v1.04.h" // for MSG22xx
#include "msg2xxx_lf_cf168_v2.02.h"
...
//                    input_report_key(g_InputDevice, KEY_POWER, 1);
 ...
 //                   input_report_key(g_InputDevice, KEY_POWER, 0);
                ...
                case 0x67:
                    ...
                    input_report_key(g_InputDevice, KEY_GESTURE_E, 1);
//                    input_report_key(g_InputDevice, KEY_POWER, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEY_GESTURE_E, 0);
 //                   input_report_key(g_InputDevice, KEY_POWER, 0);
                    input_sync(g_InputDevice);
                    break;
                case 0x68:
...
//                    input_report_key(g_InputDevice, KEY_POWER, 1);
 ...
 //                   input_report_key(g_InputDevice, KEY_POWER, 0);
                ...
                case 0x6A:
                    ...
                    input_report_key(g_InputDevice, KEY_GESTURE_S, 1);
//                    input_report_key(g_InputDevice, KEY_POWER, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEY_GESTURE_S, 0);
//                    input_report_key(g_InputDevice, KEY_POWER, 0);
                    input_sync(g_InputDevice);
                    break;
                case 0x6B:
...
//        RegSet16BitValue(0x160C, RegGet16BitValue(0x160C) & (~0x01));      
    ...
    sprintf(*ppVersion, "%03d%03d", *pMajor, *pMinor);
	dw_version = (*pMajor * 1000 + *pMinor);
	printk("wilson tp version: %d, line:%d\n", dw_version, __LINE__);
}
