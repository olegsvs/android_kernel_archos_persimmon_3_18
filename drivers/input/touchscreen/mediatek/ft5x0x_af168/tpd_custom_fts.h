#ifndef TPD_CUSTOM_FTS_H__
#define TPD_CUSTOM_FTS_H__
...
//add by major for menu key change to app switch
#define TOUCH_KEY_APP_SWITCH (580)

#ifdef CONFIG_MENU_KEY_TO_APP_SWITCH
#define TPD_KEYS                { KEY_BACK, KEY_HOMEPAGE, TOUCH_KEY_APP_SWITCH}
#else
#define TPD_KEYS                { KEY_BACK, KEY_HOMEPAGE, KEY_MENU}
#endif
//add end

#define TPD_KEYS_FACTORY         { KEY_BACK, KEY_HOME, KEY_MENU} //addb by major for factory test 
...
#ifdef FTS_GESTRUE
#define  KEY_GESTURE_U 269
#define  KEY_GESTURE_UP 266
#define  KEY_GESTURE_DOWN 265
#define  KEY_GESTURE_LEFT 267 
#define  KEY_GESTURE_RIGHT 268
#define  KEY_GESTURE_O 258
#define  KEY_GESTURE_E 253
#define  KEY_GESTURE_C 251
#define  KEY_GESTURE_M 257 
#define  KEY_GESTURE_W 262
#define  KEY_GESTURE_S 260 
#define  KEY_GESTURE_V 261
