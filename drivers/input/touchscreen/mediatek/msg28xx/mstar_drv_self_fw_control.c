        ...
        if ((pPacket[1] == 0xFF) && (pPacket[2] == 0xFF) && (pPacket[3] == 0xFF) && (pPacket[4] == 0xFF) && (pPacket[6] == 0xFF))
        {
            ...
            {   /* 0x00 is key up, 0xff is touch screen up */
                ...
                if (tpd_dts_data.use_tpd_button)
                {
                    ...
                    {
                        pInfo->tPoint[0].nX = tpd_dts_data.tpd_key_dim_local[1][0];
                        pInfo->tPoint[0].nY = tpd_dts_data.tpd_key_dim_local[1][1];
                    }
                    else if (pPacket[5] == 1) // TOUCH_KEY_MENU
                    {
                        pInfo->tPoint[0].nX = tpd_dts_data.tpd_key_dim_local[0][0];
                        pInfo->tPoint[0].nY = tpd_dts_data.tpd_key_dim_local[0][1];
                    }           
                    else if (pPacket[5] == 2) // TOUCH_KEY_BACK
                    {
                        pInfo->tPoint[0].nX = tpd_dts_data.tpd_key_dim_local[2][0];
                        pInfo->tPoint[0].nY = tpd_dts_data.tpd_key_dim_local[2][1];
                    }           
                    else if (pPacket[5] == 8) // TOUCH_KEY_SEARCH 
                    {	
                        pInfo->tPoint[0].nX = tpd_dts_data.tpd_key_dim_local[3][0];
                        pInfo->tPoint[0].nY = tpd_dts_data.tpd_key_dim_local[3][1];
                    }
                    else
                    {
